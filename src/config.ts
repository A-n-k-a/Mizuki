...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://mizuki.anka2.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "898470", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	toc: {
		enable: true, // 启用目录功能
		depth: 3, // 目录深度，1-6，1 表示只显示 h1 标题，2 表示显示 h1 和 h2 标题，依此类推，默认为3
	},
